...
STARTUPS_DATA = [
    ("OpenAI", "USA", "AI research and deployment company", 2015, "Active"),
    ("Stripe", "USA", "Financial infrastructure platform for the internet", 2010, "Active"),
    ("Databricks", "USA", "Unified data analytics platform", 2013, "Active"),
    ("SpaceX", "USA", "Spacecraft manufacturer and satellite communications", 2002, "Active"),
    ("Epic Games", "USA", "Video game and software developer and publisher", 1991, "Active"),
    ("Canva", "Australia", "Online design and publishing tool", 2013, "Active"),
    ("Plaid", "USA", "Data network powering the fintech tools", 2013, "Active"),
    ("Airtable", "USA", "Low-code platform for building collaborative apps", 2012, "Active"),
    ("Figma", "USA", "Collaborative web application for interface design", 2012, "Active"),
